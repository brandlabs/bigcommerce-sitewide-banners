(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["SiteWideBanners"] = factory();
	else
		root["SiteWideBanners"] = factory();
...
var BANNER_URL = '/sitewide-banners/';
...
function getBannerPageContent() {
    /* eslint no-undef: "off" */
    return fetch(BANNER_URL, { credentials: 'same-origin' }).then(function (page) {
        return page.text();
    });
}
 ...
 */
function insertBanner($element, banners) {
    var location = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';

    var dataBannerLocation = location === 'top' ? '="top"' : location === 'bottom' ? '="bottom"' : '';
...
module.exports = function () {
    function SiteWideBanners() {
        _classCallCheck(this, SiteWideBanners);
    ...
    _createClass(SiteWideBanners, [{
        key: 'getBanners',
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                var siteWideBannerText, $fragment, $topBannerSection, $bottomBannerSection;
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return getBannerPageContent();

                            case 2:
                                siteWideBannerText = _context.sent;
                            ...
                            case 5:
                                ...
                                $topBannerSection = $fragment.querySelector('[data-banner-location="top"] > .banner');
                                $bottomBannerSection = $fragment.querySelector('[data-banner-location="bottom"] > .banner');
                                ...
                                return _context.abrupt('return', this.banners);
        ...
        value: function addBanners() {
            var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
                ...
                place = _ref2$place === undefined ? this.banners.top.length ? 'top' : 'bottom' : _ref2$place,
                _ref2$banners = _ref2.banners,
                banners = _ref2$banners === undefined ? this.banners.top.length ? this.banners.top : this.banners.bottom : _ref2$banners;

            var $element = null;

            if (place === 'top') {
                var $currentBanner = document.querySelector('.banners[data-banner-location="top"]');
                if ($currentBanner) {
                ...
                var _$currentBanner = document.querySelector('.banners[data-banner-location="bottom"]');
                if (_$currentBanner) {
                    return; // we don't want to override an existing banner
                }
